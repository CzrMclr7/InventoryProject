...
BEGIN 
    ...
    VALUES  
    (100, 'Laptop', 10, 49999.99, GETDATE(), 1), 
    (101, 'Monitor', 25, 8999.99, GETDATE(), 1), 
    (102, 'Mouse', 100, 599.99, GETDATE(), 1), 
    (103, 'Keyboard', 75, 999.99, GETDATE(), 1), 
    (104, 'Webcam', 30, 2499.99, GETDATE(), 1); 
END
ELSE
BEGIN 
